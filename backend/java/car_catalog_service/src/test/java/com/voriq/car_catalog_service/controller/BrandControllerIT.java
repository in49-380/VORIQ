...
import static com.voriq.car_catalog_service.config.SecurityConfig.BRANDS_URL;
...
class BrandControllerIT {
    ...
    class getAllTests {
        ...
        public void get_all_brands_should_return_200() throws Exception {
            ...
            String responseBody = result.getResponse().getContentAsString();
            ItemResponseDto<String> dto = mapper.readValue(responseBody, BrandResponseDto.class);
        ...
        public void get_all_brands_when_empty_should_return_empty_list() throws Exception {
        ...
        void get_all_brands_should_return_503_when_database_unavailable() throws Exception {
            try {
                doThrow(new RuntimeException("DB down"))
                        .when(brandJdbcRepository).findAll();
