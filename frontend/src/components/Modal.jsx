...
const Modal=({open, onOpenChange, children, title, description})=>
...
<Dialog.Root modal open={open} onOpenChange={onOpenChange}>
  <Dialog.Portal>
    ...
    <Dialog.Content  className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
             w-[90vw] max-w-md bg-white border-2 border-red-500 rounded-md
             p-6 shadow-lg text-black text-lg font-bold"
